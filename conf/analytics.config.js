...
module.exports = {
  ...
  UMAMI_HOST: process.env.NEXT_PUBLIC_UMAMI_HOST || 'https://umami.1988123.xyz/script.js', // umami的服务地址
  UMAMI_ID: process.env.NEXT_PUBLIC_UMAMI_ID || 'd18da495-265d-4bab-ab2e-7c0941e3b26c', // umami的id
